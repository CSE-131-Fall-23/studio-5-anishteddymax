...
public class DistanceBetweenTest {
	...
	public void testIdenticalPoints() {
		...
		assertEquals(5.0, // The value we expect to get (to pass the test)
				Methods.distanceBetween(8.0, 9.0, 5.0, 5.0), // The thing to test
				1e-5);
		// This uses double, which are imprecise, so
